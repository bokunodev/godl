...
func init() {
	...
	flag.BoolVar(&follow, "follow-redirection", true, "Follow http redrection 3xx")
	flag.BoolVar(&dump, "dump-http-header", false, "Dump http request and respose header to stderr")
